...
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq add [username] [seconds] [content...] | - Adds a test item to the timed event queue. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq accept [id] | - Accepts an item (default: top pending) and starts its timer. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq reject [id] | - Rejects an item (default: top pending) and removes it. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq complete [id] | - Completes the active (or specified) item and removes it. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq accepting [on/off] | - Toggles whether the queue accepts new items. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq pause | - Pauses the active item's timer. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq resume | - Resumes the active item's timer. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq addtime [seconds] | - Adds (or subtracts, if negative) seconds on the active item. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq list | - Lists the current timed event queue. |
| ./custom/timedEventQueue/timedEventQueueSystem.js | !teq clear | - Clears the entire timed event queue. |
| ./custom/multiCurrency/multiCurrencySystem.js | !currency | - Show your balances across all defined currencies |
| ./custom/multiCurrency/multiCurrencySystem.js | !currency [currencyId] | - Show your balance in one currency |
| ./custom/multiCurrency/multiCurrencySystem.js | !currency list | - List the defined currencies |
| ./custom/multiCurrency/multiCurrencySystem.js | !currency give [username] [currencyId] [amount] | - Give a user an amount of a currency |
| ./custom/multiCurrency/multiCurrencySystem.js | !currency take [username] [currencyId] [amount] | - Take an amount of a currency from a user |
| ./custom/multiCurrency/multiCurrencySystem.js | !currency set [username] [currencyId] [amount] | - Set a user's balance in a currency |
...
| ./custom/giftSubCurrencyRewards/giftSubCurrencyRewards.js | !giftcurrencyreward set [giftsub&#124;giftsub2&#124;giftsub3&#124;sub1&#124;sub2&#124;sub3&#124;subprime&#124;resub1&#124;resub2&#124;resub3&#124;resubprime&#124;bits&#124;streamelements] [currencyId] [formula] | - Set a direct source-to-currency formula |
| ./custom/giftSubCurrencyRewards/giftSubCurrencyRewards.js | !giftcurrencyreward remove [giftsub&#124;giftsub2&#124;giftsub3&#124;sub1&#124;sub2&#124;sub3&#124;subprime&#124;resub1&#124;resub2&#124;resub3&#124;resubprime&#124;bits&#124;streamelements] [currencyId] | - Remove a direct source-to-currency formula |
